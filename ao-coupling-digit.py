...
# Save PCHIP fit
# --------------------
output_file = "ao-coupling/fibre_offaxis_vs_distance_pchip.txt"
np.savetxt(output_file, np.column_stack([x_pchip, y_pchip]),
           header="# Distance  Fibre_OffAxis", comments='', fmt='%.8e')
print(f"PCHIP fit saved to {output_file}")
