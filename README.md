...
5. For calculating the star at the central spaxel only, you need to use the <code>centralspaxel</code> flag. This fill set the coupling to 0.45.<br>
<code>python makecsv.py WISPIT2_star_BT-Settl-CIFIST-4400K-4logg_140000.txt centralspaxel</code>
