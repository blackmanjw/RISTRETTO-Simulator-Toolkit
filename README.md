...
8. Test the Pyechelle input with <br><code>python testinput.py WISPIT2b_BT-Settl-CIFIST-1400K-4logg_140000_Ha_60_12.txt</code>. This adds noise and scales it to a set exposure time (by defauly 3600s). You can also run testinput_phoenix.py to run the same code by for a phoenix theoretical spectra. By default it is setup for PDS70.
