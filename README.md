...
3. Add the simulated H-alpha from Yuhiko Aoyama's model. <br><code>python add-halpha.py 2MJ1612b_BT-Settl-CIFIST-1200K-3.5logg_140000.txt Ha_60_12.dat
#</code>
4. Convert to input for Pyechelle, eg. <code> python makecsv.py PDS70b_BT-Settl-CIFIST-1400K-4logg_140000_Ha_60_12.txt</code>
