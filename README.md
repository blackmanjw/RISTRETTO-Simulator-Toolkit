...
2. Downsample to spectral resolution of 140,000 (input is in the millions). <code>python resample.py PDS70c_BT-Settl-CIFIST-1300K-4logg.txt --R 140000</code> The --R parameter (desired resolution for resampling) is optional.
3. Add the simulated H-alpha from Yuhiko Aoyama's model. <code>python add-halpha.py 2MJ1612b_BT-Settl-CIFIST-1200K-3.5logg_140000.txt Ha_60_12.dat
#</code>
